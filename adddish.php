<?php
	...
	if (isset($_SESSION['usergroup'])){
		if($_SESSION['usergroup'] == 1){
			...
			if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['aDishName']) && isset($_POST['typeSelect']) && isset($_POST['aDishIngredients']) && isset($_POST['aDishDescription']) && isset($_POST['aDishServing']) && isset($_FILES['aDishPhoto']) && isset($_POST['aDishPrice']) && isset($_POST['allSelect'])){
